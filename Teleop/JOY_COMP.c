...
#pragma config(Motor,  mtr_S1_C1_1,     rightwheelA,   tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C1_2,     leftwheelA,    tmotorTetrix, openLoop, reversed)
#pragma config(Motor,  mtr_S1_C2_1,     rightwheelB,   tmotorTetrix, openLoop, reversed)
#pragma config(Motor,  mtr_S1_C2_2,     leftwheelB,    tmotorTetrix, openLoop)
